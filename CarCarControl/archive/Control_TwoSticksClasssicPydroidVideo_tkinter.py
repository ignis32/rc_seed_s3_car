...
def display_mjpeg_stream(stream_url, canvas, root):
    last_frame = None
        ...
        try:
            ...
            for chunk in stream.iter_content(chunk_size=1024):
                ...
                if a != -1 and b != -1:
                    ...
                    window_size = (canvas.winfo_width(), canvas.winfo_height())
...
if __name__ == "__main__":
    ...
    stream_thread = threading.Thread(target=display_mjpeg_stream, args=(stream_url, canvas, root))

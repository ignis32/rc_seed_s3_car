        ...
        try:
            ...
            if stream.status_code != 200:
                ...
                if last_frame is not None:
                    ...
                    cv2.putText(last_frame, data_text, (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
            ...
            for chunk in stream.iter_content(chunk_size=1024):
                ...
                if a != -1 and b != -1:
                    ...
                    # Display FPS and data on frame
                    fps_text = f"FPS: {fps:.2f}"
                    data_text = f"Data: {total_data_received / 1e6:.2f} MB"
                    cv2.putText(frame, fps_text, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
                    cv2.putText(frame, data_text, (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
